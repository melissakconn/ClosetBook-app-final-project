...
class Page extends React.Component{
    ...
    state = { name: "", category: "", description: "", picture: "", items: [ ], itemId: '' , whattuilf: '' }
    ...
    render() {
        ...
        console.log("WTUIL4: ", this.state.whattuilf)
            ...
            <div>
                ...
                <div className="maincontent" >
                    ...
                    <div className='Homeright'>
                        <input className="searchbar" placeholder="What are you wearing today?" type="text" value={ this.state.whattuilf } onChange={ (e) => { this.setState({ whattuilf: e.target.value }) } } />
                        <p>All Items:</p>

                        <div>
                            { this.state.items.filter((z) => { return `${z.description} ${z.name} ${z.category}`.toLowerCase().includes(this.state.whattuilf.toLowerCase()) }).map((x) => {return <Template key={x.id} info={x}  /> })  }
                        </div>
